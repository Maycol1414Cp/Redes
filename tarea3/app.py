...
def set_preferences():
    ...
    response.set_cookie('font_type', font_type, max_age=60)  # Cookie con tiempo 60 segundos
    response.set_cookie('font_color', font_color, max_age=60)
...
def visit_link(link):
    ...
    response.set_cookie('visited_links', visited_links)#tiempo de vida de la cookie ilimitado
